...
@Component({
  selector: 'app-brandselection',
  templateUrl: './brandselection.component.html',
  styleUrls: ['./brandselection.component.css']
})
export class BrandselectionComponent {
 ...
 selectBrand(name:string) {
  ...
  this.router.navigate(['/car-insurance/car-selection', name]);
 }
}
